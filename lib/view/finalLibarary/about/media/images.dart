...
class AboutImageScreen extends StatefulWidget {
  late int id;
  AboutImageScreen({
    Key? key,
    required this.id,
  ...
  @override
  State<AboutImageScreen> createState() => _Home_PageState();
}

class _Home_PageState extends State<AboutImageScreen> {
  final libarary_media_controller = Get.put(LibararyMediaController());
  late GlobalKey<ScaffoldState> _scaffoldKey;

  @override
  void initState() {
    libarary_media_controller.getAboutMedia(widget.id, 2);
    super.initState();
  }
