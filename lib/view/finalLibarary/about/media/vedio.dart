...
class _LibararyVideoScreenState extends State<AboutVideoScreen> {
      ...
      builder: (context) => AlertDialog(
        ...
        content: SizedBox(
          ...
          child: CustomVideoPlayer(
              url:
                  "https://cemetery2.bmwit.com/public/AboutTheOfficeOfCemeteriesAffairController-details/${video.media}"),
        ),
      ),
    );
  }
