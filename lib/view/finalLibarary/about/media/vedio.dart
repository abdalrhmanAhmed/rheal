...
class AboutVideoScreen extends StatefulWidget {
  late int id;
  AboutVideoScreen({
    Key? key,
    required this.id,
  ...
  @override
  _AboutVideoScreenState createState() => _AboutVideoScreenState();
}

class _AboutVideoScreenState extends State<AboutVideoScreen> {
  final libararyMediaController = Get.put(LibararyVideoMediaController());

  @override
  void initState() {
    libararyMediaController.getAboutVideoMedia(widget.id, 1);
    super.initState();
  }
                      ...
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) => FullScreenVideoPlayer(
                            url:
                                "https://cemetery2.bmwit.com/public/AboutTheOfficeOfCemeteriesAffairController-details/${libararyMediaController.libarary_media_video[index].media}",
                          ),
                        ),
                      );
                    },
