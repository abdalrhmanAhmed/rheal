...
class ProjectTextScreen extends StatefulWidget {
  late int id;
  ProjectTextScreen({
    Key? key,
    required this.id,
  ...
  @override
  State<ProjectTextScreen> createState() => _LibararyTextScreenState();
}

class _LibararyTextScreenState extends State<ProjectTextScreen> {
  final libararyMediaController = Get.put(LibararyMediaController());
  late GlobalKey<ScaffoldState> _scaffoldKey;

  @override
  void initState() {
    libararyMediaController.getProjectMedia(widget.id, 0);
    super.initState();
  }
