...
class ProjectScreen extends StatefulWidget {
  ...
  @override
  State<ProjectScreen> createState() => _Home_PageState();
}

class _Home_PageState extends State<ProjectScreen> {
  final categorieController = Get.put(CategoryController());

  @override
  void initState() {
    categorieController.getProject();
    super.initState();
  }
                ...
                : RefreshIndicator(
                    ...
                    onRefresh: () {
                      return Future.delayed(
                        Duration(seconds: 1),
                        () async {
                          await categorieController.getProject();
                        },
                      );
                    },
              ...
              child: Container(
                decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                    image: NetworkImage(
                      "https://cemetery2.bmwit.com/public/Project-profile/${cats.image}",
                    ),
                    fit: BoxFit
