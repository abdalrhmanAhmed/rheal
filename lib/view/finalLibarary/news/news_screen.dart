...
class NewsScreen extends StatefulWidget {
  ...
  @override
  State<NewsScreen> createState() => _Home_PageState();
}

class _Home_PageState extends State<NewsScreen> {
  final categorieController = Get.put(CategoryController());

  @override
  void initState() {
    categorieController.getNews();
    super.initState();
  }
              ...
              child: Container(
                decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                    image: NetworkImage(
                      "https://cemetery2.bmwit.com/public/News-profile/${cats.image}",
                    ),
                    fit: BoxFit
